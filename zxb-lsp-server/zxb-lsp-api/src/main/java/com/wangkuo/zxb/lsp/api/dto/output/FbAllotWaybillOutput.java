...
public class FbAllotWaybillOutput implements Serializable {
    private Long id;
    ...
    public void setInformationFeeVerifiName(String informationFeeVerifiName) {
        this.informationFeeVerifiName = informationFeeVerifiName == null ? null : informationFeeVerifiName.trim();
    }
    ...
    public void setInformationFeeOverName(String informationFeeOverName) {
        this.informationFeeOverName = informationFeeOverName == null ? null : informationFeeOverName.trim();
    }
