...
public class TSbWaybillFee implements Serializable {
    private Long id;
    ...
    private BigDecimal changeFeeSum;
    ...
    public void setFreightFeeVerifiUserName(String freightFeeVerifiUserName) {
        this.freightFeeVerifiUserName = freightFeeVerifiUserName == null ? null : freightFeeVerifiUserName.trim();
    }
    ...
    public void setFreightFeeOverUserName(String freightFeeOverUserName) {
        this.freightFeeOverUserName = freightFeeOverUserName == null ? null : freightFeeOverUserName.trim();
    }
    ...
    public void setBusinessFeeVerifiUserName(String businessFeeVerifiUserName) {
        this.businessFeeVerifiUserName = businessFeeVerifiUserName == null ? null : businessFeeVerifiUserName.trim();
    }
    ...
    public void setBusinessPaymentUserName(String businessPaymentUserName) {
        this.businessPaymentUserName = businessPaymentUserName == null ? null : businessPaymentUserName.trim();
    }
    ...
    public void setBusinessFeeOverUserName(String businessFeeOverUserName) {
        this.businessFeeOverUserName = businessFeeOverUserName == null ? null : businessFeeOverUserName.trim();
    }
    ...
    public void setZbReceiptVerifyUserName(String zbReceiptVerifyUserName) {
        this.zbReceiptVerifyUserName = zbReceiptVerifyUserName == null ? null : zbReceiptVerifyUserName.trim();
    }
    ...
    public void setZbWithSiteBalanceUserName(String zbWithSiteBalanceUserName) {
        this.zbWithSiteBalanceUserName = zbWithSiteBalanceUserName == null ? null : zbWithSiteBalanceUserName.trim();
    }
    ...
    public void setLateFeeVerifyUserName(String lateFeeVerifyUserName) {
        this.lateFeeVerifyUserName = lateFeeVerifyUserName == null ? null : lateFeeVerifyUserName.trim();
    }
    ...
    public void setZbWithSiteMonthBalanceUserName(String zbWithSiteMonthBalanceUserName) {
        this.zbWithSiteMonthBalanceUserName = zbWithSiteMonthBalanceUserName == null ? null : zbWithSiteMonthBalanceUserName.trim();
    }
    ...
    public void setReceiveTimeoutBalanceUserName(String receiveTimeoutBalanceUserName) {
        this.receiveTimeoutBalanceUserName = receiveTimeoutBalanceUserName == null ? null : receiveTimeoutBalanceUserName.trim();
    }
    ...
    public void setDamagerFeeBalanceUserName(String damagerFeeBalanceUserName) {
        this.damagerFeeBalanceUserName = damagerFeeBalanceUserName == null ? null : damagerFeeBalanceUserName.trim();
    }
    ...
    public BigDecimal getChangeFeeSum() {
        return changeFeeSum;
    }

    public void setChangeFeeSum(BigDecimal changeFeeSum) {
        this.changeFeeSum = changeFeeSum;
    }
}